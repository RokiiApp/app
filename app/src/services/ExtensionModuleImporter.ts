...
import { ExternalModuleImporter as EMI } from "@/services/ExternalModuleImporter";
import { Extension } from "@/extensions/Extension";

type ImportedExtensionModule = { default: ExtensionModule };
...
const ExtensionModuleImporter = {
  ...
  get: async (extensionName: string) => {
    ...
    try {
      const module = await EMI.import<ImportedExtensionModule>(pluginPath, forceCacheBust);
